import pytest
from app.clinical_intelligence.thyroid import generate_guidance

def test_thyroid_generate_guidance_high_risk():
...
def test_thyroid_generate_guidance_low_risk():
