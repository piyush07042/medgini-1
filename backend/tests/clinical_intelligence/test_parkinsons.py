import pytest
from app.clinical_intelligence.parkinsons import generate_guidance

def test_parkinsons_generate_guidance_high_risk():
...
def test_parkinsons_generate_guidance_low_risk():
