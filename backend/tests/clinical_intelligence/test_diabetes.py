import pytest
from app.clinical_intelligence.diabetes import generate_guidance

def test_diabetes_generate_guidance_high_risk():
...
def test_diabetes_generate_guidance_low_risk():
