"""
Sample Hepatitis model builder.
"""
...
def build():
    ...
    X = rng.normal(size=(280, len(feature_names))) * [15, 1.0, 30, 20, 20] + [40, 0.8, 80, 25, 30]
    y = ((X[:,1] > 2.0) | (X[:,3] > 60)).astype(int)
    ...
    print("hepatitis sample model built at", MODEL_DIR)
