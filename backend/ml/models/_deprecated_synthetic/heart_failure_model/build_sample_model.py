"""
Sample Heart Failure model builder.
"""
...
def build():
    ...
    X = rng.normal(size=(300, len(feature_names))) * [15, 10, 0.5, 5, 50] + [65, 35, 1.0, 137, 130]
    y = ((X[:,1] < 30) | (X[:,2] > 1.2)).astype(int)
    ...
    print("heart failure sample model built at", MODEL_DIR)
